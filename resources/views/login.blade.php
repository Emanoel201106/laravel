            ...
            <div class="container">
                ...
                <div>
                     <ul class="navbar-nav ms-auto">
                        <a class="menu-link" id="home" href="/"><div class="d-home">
                            <img class="home" id="i-home" src="{{url('assets/img/icones/home.png')}}"/>
                            <li class="nav-item mx-0 mx-lg-1">Início</li>
                        </div></a>
                        <a class="menu-link" id="login" href="{{url('/user-adm')}}"><div>
                            <img class="a-user" src="{{url('assets/img/icones/login.svg')}}"/>
