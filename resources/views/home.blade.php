                ...
                <div>
                     <ul class="navbar-nav ms-auto">
                        ...
                        <div>
                            ...
                            <a class="menu-link" id="favorito" href="{{route('login.index')}}"><div class="cabeçalho">
                            ...
                            <a class="menu-link" id="carrinho" href="{{route('login.index')}}"><div class="cabeçalho" id="cabeçalho">
